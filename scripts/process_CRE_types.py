    ...
    for j, pred in enumerate(pred_all):
        ...
        if np.array(index).any():
            ...
            for i in index:
                ...
                vals = []
                for k, val in enumerate(tss_df.iloc[j]):
                    if k > 0:
                        vals.append(val)
...
print('Processing enhancing context')
context = 'enhancing'
...
print('Processing neutral context')
context = 'neutral'
...
print('Processing silencing context')
context = 'silencing'
